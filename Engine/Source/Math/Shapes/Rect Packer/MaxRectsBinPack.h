...
public:
	...
	MaxRectsBinPack(int width, int height, bool allowRotate);
	...
	void Insert(MemPtr<RectSizeIndex> rects, MemPtr<RectIndex> dst, FreeRectChoiceHeuristic method);
...
private:
   ...
   void SplitFreeRects(const Rect &usedNode);

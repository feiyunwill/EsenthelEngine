...
public:
	...
	SkylineBinPack(int binWidth, int binHeight, bool useWasteMap, bool allowRotate);

	/// (Re)initializes the packer to an empty bin of width x height units. Call whenever
	/// you need to restart with a new bin.
	void Init(int binWidth, int binHeight, bool useWasteMap, bool allowRotate);
	...
	void Insert(Memp<RectSizeIndex> rects, Memp<RectIndex> dst, LevelChoiceHeuristic method);

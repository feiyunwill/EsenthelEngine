...
public:
	...
	GuillotineBinPack(int width, int height, bool allowRotate);

	/// (Re)initializes the packer to an empty bin of width x height units. Call whenever
	/// you need to restart with a new bin.
	void Init(int width, int height, bool allowRotate);
	...
	/// @param rectChoice The free rectangle choice heuristic rule to use.
	/// @param splitMethod The free rectangle split heuristic rule to use.
	void Insert(MemPtr<RectSizeIndex> rects, MemPtr<RectIndex> dst, bool merge, 
...
//		FreeRectChoiceHeuristic rectChoice, GuillotineSplitHeuristic splitMethod);
	...
	Memc<Rect> &GetFreeRectangles() { return freeRectangles; }
	...
	Memc<Rect> &GetUsedRectangles() { return usedRectangles; }

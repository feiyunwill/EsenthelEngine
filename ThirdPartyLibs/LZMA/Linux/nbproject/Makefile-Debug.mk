...
${OBJECTDIR}/_ext/c43c7845/7zStream.o: ../lzma/C/7zStream.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -D_7ZIP_ST -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/c43c7845/7zStream.o ../lzma/C/7zStream.c

${OBJECTDIR}/_ext/c43c7845/LzFind.o: ../lzma/C/LzFind.c
	${MKDIR} -p ${OBJECTDIR}/_ext/c43c7845
	${RM} "$@.d"
	$(COMPILE.c) -g -D_7ZIP_ST -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/c43c7845/LzFind.o ../lzma/C/LzFind.c

${OBJECTDIR}/_ext/c43c7845/LzmaDec.o: ../lzma/C/LzmaDec.c
	${MKDIR} -p ${OBJECTDIR}/_ext/c43c7845
	${RM} "$@.d"
	$(COMPILE.c) -g -D_7ZIP_ST -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/c43c7845/LzmaDec.o ../lzma/C/LzmaDec.c

${OBJECTDIR}/_ext/c43c7845/LzmaEnc.o: ../lzma/C/LzmaEnc.c
	${MKDIR} -p ${OBJECTDIR}/_ext/c43c7845
	${RM} "$@.d"
	$(COMPILE.c) -g -D_7ZIP_ST -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/c43c7845/LzmaEnc.o ../lzma/C/LzmaEnc.c

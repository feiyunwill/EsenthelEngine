 ...
 */
//#define MBEDTLS_SSL_PROTO_DTLS this is UDP/MBEDTLS_SSL_TRANSPORT_DATAGRAM
...
#define MBEDTLS_PLATFORM_PRINTF_MACRO // ESENTHEL, this will completely disable 'printf' usage and avoid linker errors
/* Note: your snprintf must correclty zero-terminate the buffer! */

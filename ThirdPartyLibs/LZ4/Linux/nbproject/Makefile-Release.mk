...
${OBJECTDIR}/_ext/5c0/lz4.o: ../lz4.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O3 -s -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/lz4.o ../lz4.c

${OBJECTDIR}/_ext/5c0/lz4hc.o: ../lz4hc.c
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.c) -O3 -s -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/lz4hc.o ../lz4hc.c

${OBJECTDIR}/_ext/5c0/xxhash.o: ../xxhash.c
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.c) -O3 -s -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/xxhash.o ../xxhash.c

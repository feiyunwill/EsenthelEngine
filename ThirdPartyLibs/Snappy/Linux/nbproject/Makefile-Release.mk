...
${OBJECTDIR}/_ext/5c0/snappy-c.o: ../snappy-c.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -s -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/snappy-c.o ../snappy-c.cpp

${OBJECTDIR}/_ext/5c0/snappy-sinksource.o: ../snappy-sinksource.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -s -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/snappy-sinksource.o ../snappy-sinksource.cpp

${OBJECTDIR}/_ext/5c0/snappy.o: ../snappy.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -s -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/snappy.o ../snappy.cpp

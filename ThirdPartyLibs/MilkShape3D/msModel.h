...
struct ms3d_group_t
{
	unsigned char flags;
	char name[32];
	std__vector<unsigned short> triangleIndices;
	char materialIndex;
...
struct ms3d_joint_t
{
	...
	std__vector<ms3d_keyframe_t> rotationKeys;
	std__vector<ms3d_keyframe_t> positionKeys;
	std__vector<ms3d_tangent_t> tangents;
